...
.chat-close:hover { color: var(--c-txt); }
...
.chat-msg-bubble :deep(p) { margin-bottom: 8px; }
...
.chat-input:focus { outline: none; border-color: var(--c-purple); }
.chat-input::placeholder { color: var(--c-txt3); font-size: 12px; }
